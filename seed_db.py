...
places = [
    ...
    "KADIKÖY RIHTIM",
    "SARAÇHANE",
    "ŞİŞLİ KURTULUŞ CADDESİ",
    "LEVENT SAPPHİRE ÖNÜ",
    "BEŞİKTAŞ BARBAROS BULVARI",
    "FSM KÖPRÜSÜ",
    "DOLMABAHÇE SARAYI",
    "MAÇKA PARKI",
    "TAKSİM GEZİ PARKI",
    "BAĞDAT CADDESİ SUADİYE IŞIKLAR"
]
...
def seed_db():
    ...
    try:
        ...
        if db.query(DailySelection).filter(func.date(DailySelection.date) == date.today()).first() is None:
